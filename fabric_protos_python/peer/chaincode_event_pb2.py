...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'peer.chaincode_event_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CHAINCODEEVENT']._serialized_start=38
  _globals['_CHAINCODEEVENT']._serialized_end=128
